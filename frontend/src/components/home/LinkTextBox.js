        ...
        <div className="w-full  flex gap-2">
          <div className=" rounded-lg shadow-md w-full">
            <input
              ...
              className="w-full h-full p-3 bg-white/10 focus:ring-0 focus:outline-none border backdrop-blur-md border-white/70 rounded-lg placeholder-white/50 text-white transition-all duration-400 ease-out focus:shadow-[0_0_75px_10px_rgba(255,255,255,0.3)] hover:shadow-[0_0_15px_3px_rgba(255,255,255,0.3)]"
              value={repoUrl}
          ...
          <div className=" rounded-lg p-[3px] bg-gradient-to-r from-[#02c6ff] via-[#0066ff] to-[#da00ff] transition-all duration-300 hover:scale-105 hover:shadow-[0_0_15px_10px_rgba(0,128,255,0.3)] ease-in-out shadow-[0_0_5px_3px_rgba(0,128,255,0.5)]">
            <button
              className="w-full h-full font-figtree  bg-[#030617]  rounded-lg  text-center text-white font-semibold p-3  "
              type="submit"
            >
              Submit
            </button>
